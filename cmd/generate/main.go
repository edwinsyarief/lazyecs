...
func main() {
	...
	for _, tplFile := range templates {
		...
		outFile.WriteString("// Code generated by go generate; DO NOT EDIT.\n")
		outFile.WriteString("package lazyecs\n\n")

		switch tplFile {
		case "batch.go.tpl", "get_component.go.tpl", "query.go.tpl":
			outFile.WriteString("import \"unsafe\"\n")
...
func buildTemplateData(n int) TemplateData {
	...
	var types, typeVars, vars, ids, okIDs, returnTypes, returnSinglePtrs, returnPtrs, returnVars, returnNil, slotCheck, batchRes, returnBatchRes, returnFromBytes []string
